    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' && 'album' in content && content.album) {
                ...
                let mediaHandle;
                if ('audio' in content && content.ptt) {
                    content.audio = await (0, Utils_1.convertAudioToOpus)(content.audio);
                }
                ...
                const delayMs = config.messageSendDelay + (Math.random() * config.messageSendDelay * 0.5 * (Math.random() < 0.5 ? 1 : -1));
