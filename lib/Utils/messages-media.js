...
const ffmpeg_installer_1 = require("@ffmpeg-installer/ffmpeg");
fluent_ffmpeg_1.default.setFfmpegPath(ffmpeg_installer_1.path);
...
async function convertAudioToOpus(buffer) {
    return new Promise((resolve, reject) => {
        ...
        readable.push(null);
        const bufs = [];
        (0, fluent_ffmpeg_1.default)(readable)
            .fromFormat('mp3')
            .toFormat('opus')
            .on('error', reject)
